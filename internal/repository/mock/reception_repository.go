...
//
//	mockgen --source=reception_repository.go --destination=mock/reception_repository.go --package=mock
//
...
func (m *MockReceptionRepository) CreateReception(ctx context.Context, pvzID string) (string, error) {
	m.ctrl.T.Helper()
